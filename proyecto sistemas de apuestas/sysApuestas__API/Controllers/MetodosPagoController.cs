...
namespace sysApuestas__API.Controllers
{
    ...
    public class MetodosPagoController : ControllerBase
    {
        ...
        public MetodosPagoController(SysApuestasContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<MetodosPago>> PostMetodosPago(MetodosPago metodosPago)
        {
            ...
            return CreatedAtAction("GetMetodosPago", new { id = metodosPago.IdMetodo }, metodosPago);
        }
        ...
        {
            return _context.MetodosPago.Any(e => e.IdMetodo == id);
        }
    }
}
